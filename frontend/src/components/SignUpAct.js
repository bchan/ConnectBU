...
const Research = [
    ...
    { title: 'Artificial Intelligence and Emerging Media (AIEM)'},
    { title: 'IMAGE & VIDEO COMPUTING'},
    { title: 'Social Learning Laboratory'},
    { title: 'Porco Research Group'},
    { title: 'Computational Electronics Lab'},
    { title: 'Nanomaterials & Nanostructure Optics'},
    { title: 'Nanostructured Fibers and Nonlinear Optics Lab'},
    { title: 'OpticL Characteization & Nanophotonics Laboratory'},
    { title: 'Paiella Research Group'},
    { title: 'Quantum Communication, Computing, & Measurement Laboratory'},
    { title: 'The Sharifzadeh Group'},
    { title: 'Ultrafast Optics Laboratory'},
    { title: 'VLSI and Neural Net Systems (VNNS) Laboratory'},
    { title: 'Yang Research Laboratory'},
    { title: 'Adaptive and Secure Computing Systems'},
    { title: 'Computer Architecture and Automated Design Lab'},
    { title: 'Dependable Computing Laboratory'},
    { title: 'Integrated Circuits & System Group'},
    { title: 'Multimedia Communications Lab'},  
    { title: 'Laboratory of Networking & Information Systems'},
    { title: 'Performance & Energy-Aware Computing Laboratory'},
    { title: 'VLSI and Neural Net Systems (VNNS) Laboratory'},
    { title: 'Biomedical Optics Lab'},
    { title: 'Chenge Group'},
    { title: 'Computational Imaging Systems Lab'},
    { title: 'Information and Data Sciences (IDS)'},
    { title: 'Optical Characterization and Nanophotonics'},
    { title: 'Semeter Space'},
    { title: 'Signal Transformation and Information Representaion'},
    { title: 'Ultrafast Optics'},
    { title: 'Visual Information Processing'},
    { title: 'Complex BioSignal Processing'},
    { title: 'Computer Vision and Computational Neuroscience'},
    { title: 'Control of Discrete Event Systems'},
    { title: 'Data Science and Machine Learning'},
    { title: 'Dependable Computing'},
    { title: 'Information and Data Sciences'},
    { title: 'Multimedia Communications'},
    { title: 'Network Optimization and Control'},
    { title: 'Reliable Computing'},
    { title: 'Visual Information Processing'},
    { title: 'Complex BioSignal Processing'},
    { title: 'Cross-Disciplinary Integration of Design Automation Research'},
    { title: 'Control of Discrete Event Systems'},
    { title: 'Design, Automation, Manufacturing, and Prototyping'},
    { title: 'Information and Data Sciences'},
    { title: 'Multimedia Communications'},
    { title: 'Network Optimization and Control'},
    { title: 'Visual Information Processing'},
  ...
  const interest = [
    ...
    { title: 'BAKING'},
    { title: 'REFINISHING FURNITURE'},
    { title: 'FLEA MARKET SHOPPING'},
    { title: 'CATERING'},
    { title: 'MAKING MUSIC'},
    { title: 'TAPPING MAPLE TREES'},
    { title: 'BARTENDING'},
    { title: 'WINE MAKING'},
    { title: 'PLAYING THE STOCK MARKET'},
    { title: 'TAKING PAID SURVEYS'},
    { title: 'BEEKEEPING'},
    ...
    { title: 'DRIVE OTHERS AROUND'},
    { title: 'GRAPHIC DESIGN'},
    { title: 'MAKING T-SHIRTS'},
    { title: 'BECOMING A FITNESS INSTRUCTOR'},
    { title: 'STARTING A YOUTUBE CHANNEL'},
    { title: 'BEING A HANDYMAN'},
    { title: 'DECORATING HOMES'},
    { title: 'REVIEWING THINGS'},
    { title: 'PET SITTING'},
    { title: 'FLIPPING ITEMS'},
    { title: 'BECOMING A LOCAL GUIDE'},
    { title: 'PURSUING CREDIT CARD REWARDS'},
    { title: 'SOCIAL MEDIA'},
    { title: 'BUYING AND SELLING'},
    { title: 'CREDIT CARD COLLECTING'},
    { title: 'CREATING AND/OR EDITING VIDEOS'},
    { title: 'GIVING ADVICE OR OPINIONS'},
    { title: 'CREATE OR SELL PET CLOTHING'},
    { title: 'CREATE AND SELL GOURMET PET TREATS'},
    { title: 'ENGRAVINGS'},
    { title: 'COMPUTER TECHNICIAN'},
    { title: 'AUTO DETAILING'},
    { title: 'TEACHING AND TUTORING MUSIC'},
    { title: 'AUTO CUSTOMIZATION'},
    { title: 'FITNESS OR YOGA TRAINER'},
    ...
    { title: 'LIFE COACHING'},
    { title: 'CARTOONING & ANIMATION'},
    { title: 'WRITING MUSIC'},
    { title: 'TUTORING CHILDREN'},
    { title: 'FLOWER ARRANGING'},
    { title: 'COUPONING'},
    { title: 'MOBILE TECHNICIAN'},
    { title: 'COACHING LOCAL SPORTS'},
    { title: 'BICYCLING'},
    { title: 'ARTS AND CRAFTS'},
    { title: 'GENEALOGY'},
    { title: 'ROCK PAINTING'},
    { title: 'MAKING TIME CAPSULES'},
    { title: 'DOG TRAINING'},
    { title: 'ROAD BIKING'},
    { title: 'MEDITATION'},
    { title: 'WALKING'},
    ...
    { title: 'TAKING FREE ONLINE CLASSES'},
    { title: 'MAGIC TRICKS & CARD TRICKS'},
    { title: 'KEEP ABREAST OF NEWS AND CURRENT AFFAIRS'},
    { title: 'WATCH DOCUMENTARIES'},
    { title: 'GUERRILLA GARDENING'},
    { title: 'LEARN ABOUT PHILOSOPHY'},
    { title: 'URBAN FRUIT PICKING'},
    { title: 'MINIMALISM'},
    { title: 'JOURNALING'},
    { title: 'GO TO FREE COMMUNITY EVENTS'},
    { title: 'FOSTERING ANIMALS'},
    { title: 'BECOME A WIKIPEDIA EDITOR'},
    { title: 'DECLUTTERING'},
    { title: 'UPCYCLING'},
    { title: 'READING'},
    { title: 'MAKING MINIATURES'},
    { title: 'SINGING'},
    { title: 'TATEBANKO'},
    { title: 'QUILLING'},
    ...
    { title: 'ARCHAEOLOGY'},
    { title: 'PLAYING CHESS'},
    { title: 'CIRCUITS TRAINING'},
    { title: 'LEARNING HOW TO DIY'},
    { title: 'SUDOKU'},
    { title: 'PARTICIPATE IN TRIVIA CONTESTS'},
    { title: 'NOODLING'},
    { title: 'ATTEND RENAISSANCE FAIRS'},
    { title: 'FENG SHUI DECORATING'},
    { title: 'PLAN WALKING TOURS'},
    { title: 'CRABBING'},
    { title: 'BOXING'},
    { title: 'DOG WALKING'},
    { title: 'ORGANIZE A NEIGHBORHOOD CLEAN-UP'},
    { title: 'SHELL FISHING'},
    { title: 'Boxing'},
    { title: 'Dog Walking'},
    { title: 'Organize A Neighborhood Clean-Up'},
    ...
    { title: 'Lomography'},
    { title: 'Learn How To Make String Figures'},
    { title: 'Origami'},
    { title: 'Martial Arts'},
    { title: 'Working Out'},
    { title: 'Practicing Survival Skills'},
    { title: 'Adventure Running'},
    { title: 'Improving Your Memory'},
    { title: 'Metal Working'},
    { title: 'Hookah Smoking'},
    { title: 'Caving'},
    { title: 'Weight Lifting'},
    { title: 'Jogging/Training For Marathon'},
    { title: 'Spear Fishing'},
    { title: 'Car Racing'},
    { title: 'Offroading'},
    { title: 'Firearm Enthusiast'},
    { title: 'Fencing'},
    { title: 'Bouldering'},
    { title: 'Hunting'},
    ...
    { title: 'Fly Fishing'},
    { title: 'Flying'},
    { title: 'Shooting/Marksmanship'},
    { title: 'Becoming An Alcohol Connoisseur'},
    { title: 'Hiking'},
    { title: 'Collecting Military Paraphernalia'},
    { title: 'Airplane Combat'},
    { title: 'Architecture'},
    { title: 'Base Jumping'},
    { title: 'Beer Tasting'},
    { title: 'Barbecuing'},
    ...
    { title: 'Start Ground Hopping'},
    { title: 'Chainsaw Carving'},
    { title: 'Start An Allotment'},
    { title: 'Anti-Gravity Cocooning'},
    { title: 'LudoSport'},
    { title: 'Retro Gaming'},
    { title: 'Cliff Diving'},
    ...
    { title: 'Beat Box'},
    { title: 'Break Dancing'},
    { title: 'Tomahawk/Hatchet Throwing'},
    { title: 'Ice Fishing'},
    { title: 'Kitesurfing'},
    { title: 'Motocross'},
    { title: 'Paragliding'},
    ...
    { title: 'Jet Sprint Boat Racing'},
    { title: 'Drag Boat Racing'},
    { title: 'Whittling'},
    { title: 'Yoga'},
    { title: 'Snorkeling'},
    { title: 'Touring Wineries'},
    { title: 'Massage'},
    { title: 'Babysitting'},
    { title: 'Squash'},
    ...
    { title: 'Sailing'},
    { title: 'Tennis'},
    { title: 'Starting An Etsy Or EBay Store'},
    { title: 'Star Gazing'},
    { title: 'Homesteading'},
    { title: 'Canoeing'},
    { title: 'Bowling'},
    { title: 'Entertaining & Event Hosting'},
    ...
    { title: 'Pottery'},
    { title: 'Badminton'},
    { title: 'Theme Night Dates'},
    { title: 'Self-Care'},
    { title: 'World Record Breaking'},
    { title: 'Renovating'},
    { title: 'Weekend Adventuring'},
    ...
    { title: 'Sculpt With Clay/ Playdough'},
    { title: 'Collecting Seashells'},
    { title: 'Beach / Sand Building'},
    { title: 'Nature Walk'},
    { title: 'Zoo Visits'},
    { title: 'Solving Mazes'},
    { title: 'Balloon Twisting'},
    { title: 'Collecting Stickers'},
    { title: 'Collecting Leaves'},
    { title: 'Puppetry'},
    { title: 'Playing T-Ball'},
    { title: 'Mini Golf'},
    { title: 'Playing Soccer'},
    { title: 'Finger Painting'},
    { title: 'Collecting Stamps'},
    { title: 'Coloring'},
    { title: 'Lego Building/Assembling'},
    { title: 'Doll Making'},
    { title: 'Making Bird Feeders And Birdhouses'},
    { title: 'Insect Interest'},
    { title: 'Crocheting'},
    ...
    { title: 'Knitting'},
    { title: 'Skating'},
    { title: 'Speed Cubing (Rubix Cube)'},
    { title: 'Creating Family Trees'},
    { title: 'Story-Writing'},
    { title: 'Collecting Baseball Cards'},
    { title: 'Tapestry'},
    { title: 'Pencil Sketching'},
    { title: 'Comic Book Art'},
    { title: 'Jewellery Making'},
    { title: 'Doing Science Experiments'},
    { title: 'Flower Making'},
    { title: 'Learning How To Play Musical Instruments'},
    { title: 'Juggling'},
    { title: 'Kite Flying'},
    { title: 'Collecting Marbles'},
    { title: 'Roller Blading'},
    { title: 'Collage Making'},
    { title: 'Slingshots'},
    { title: 'Paper Mache'},
    { title: 'Making Bookmarks'},
    { title: 'Making Key Holders'},
    { title: 'Skateboarding'},
    { title: 'Animal Craft'},
    { title: 'Acrobatics'},
    { title: 'Jump Roping'},
    ...
    { title: 'Scouting'},
    { title: 'RC Model Racing'},
    { title: 'Stone Skipping'},
    { title: 'Gymnastics'},
    { title: 'Producing Electronic Music'},
    { title: 'Book Clubs'},
    ...
    { title: 'Knife Making'},
    { title: 'Dandyism'},
    { title: 'Collecting Model Trains'},
    { title: 'War Gaming'},
    { title: 'Making Your Own Hot Sauce'},
    { title: 'Poker'},
    { title: 'Playing Darts'},
    { title: 'Sculpting'},
    { title: 'Lockpicking'},
    ...
    { title: 'Floristry'},
    { title: 'Ghost Hunting'},
    { title: '3D Printing And Physibles'},
    { title: 'Macrame'},
    { title: 'Knapping'},
    { title: 'Lacemaking'},
    { title: 'Lapidary'},
    ...
    { title: 'Reef Aquarium'},
    { title: 'Bookbinding'},
    { title: 'Building Dollhouses'},
    { title: 'Conworlding'},
    { title: 'Dominoes'},
    { title: 'Matchstick Modeling'},
    { title: 'Impersonations'},
    { title: 'Inventing'},
    { title: 'Kitchen Chemistry'},
    { title: 'Knotting'},
    { title: 'Playing Pool/Darts/Foosball'},
    { title: 'Making Model Cars'},
    { title: 'Tarot Reading'},
    { title: 'Sushi Making'},
    { title: 'Scale Miniature Building'},
    { title: 'Collecting Diecast Cars'},
    { title: 'Building Ships In Bottles'},
    { title: 'Poetry'},
    { title: 'Beatboxing'},
    ...
    { title: 'Pet Grooming'},
    { title: 'Fruit Carving'},
    { title: 'Pencil Carving'},
    { title: 'Eggshell Carving'},
    { title: 'Creating Video Tutorials'},
    ...
    { title: 'Geocaching'},
    { title: 'Becoming A Film Buff'},
    { title: 'Treasure Hunting'},
    { title: 'Glass Blowing'},
    { title: 'Organize Fundraising'},
    { title: 'Mountain Biking'},
    { title: 'Collecting Comic Books'},
    { title: 'Neuro Linguistic Programming'},
    { title: 'Gun Collecting'},
    { title: 'Speed Reading'},
    { title: 'Snowmobiling'},
    { title: 'Shark Diving'},
    { title: 'Pyrotechnics'},
    ...
    { title: 'Herping'},
    { title: 'Grilling'},
    { title: 'Becoming A Rail Fan'},
    { title: 'Slack Lining'},
    { title: 'Tool Collecting'},
    { title: 'Building Tesla Coils'},
    { title: 'Surf Fishing'},
    ...
    { title: 'Astronomy'},
    { title: 'Boat Racing'},
    { title: 'Outrigger Canoe Racing'},
    { title: 'Kicksled'},
    { title: 'Skijoring'},
    { title: 'Kinetic Sculpture Racing'},
    { title: 'Polo'},
    { title: 'Leather Making'},
    { title: 'Rock And Mineral Collecting'},
    { title: 'Collecting Sea Glass'},
    { title: 'Upholstery'},
    { title: 'Woodburning'},
    { title: 'RV Travelling'},
    ...
    { title: 'Food Preservation (Pickling, Canning)'},
    { title: 'Using Ham Radio'},
    { title: 'Taking Part Historical Reenactments'},
    { title: 'Museum/Art Gallery Hopping'},
    { title: 'Coin Collecting'},
    { title: 'Infuse Alcohol'},
    { title: 'Being A Cigar Aficionado'},
    { title: 'Record Collecting'},
    { title: 'Being A History Buff'},
    { title: 'Terrarium Making'},
    { title: 'Farming'},
    { title: 'Aquascaping'},
    { title: 'Growing Bonsais'},
    { title: 'Meteorology'},
    { title: 'Found A Charity Group'},
    { title: 'Cartography'},
    { title: 'Taxidermy'},
    { title: 'Astrology'},
    { title: 'Cryptography'},
